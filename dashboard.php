...
<section class="dashboard">
   ...
   <div class="box-container">
      ...
      <a href="saved.php" class="btn">view saved properties</a>
            ...
            <div class="box">
      <?php
         $count_my_listings = $conn->prepare("SELECT * FROM `property` WHERE user_id = ?");
         $count_my_listings->execute([$user_id]);
         $total_my_listings = $count_my_listings->rowCount();
      ?>
      <h3><?= $total_my_listings; ?></h3>
      <p>my listings</p>
