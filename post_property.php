...
if(isset($_POST['post'])){
   ...
   $advace = filter_var($advance, FILTER_SANITIZE_STRING);
   ...
   if($image_01_size > 2000000){
      ...
      $insert_property = $conn->prepare("INSERT INTO `property`(id, user_id, property_name, address, price, type, offer, status, furnished, bhk, advance, bedroom, bathroom, balcony, carpet, total_floors, room_floor, lift, security_guard, play_ground, garden, water_supply, power_backup, parking_area, gym, shopping_mall, hospital, school, market_area, image_01, image_02, image_03, image_04, image_05, description) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"); 
      $insert_property->execute([$id, $user_id, $property_name, $address, $price, $type, $offer, $status, $furnished, $bhk, $advance, $bedroom, $bathroom, $balcony, $carpet, $total_floors, $room_floor, $lift, $security_guard, $play_ground, $garden, $water_supply, $power_backup, $parking_area, $gym, $shopping_mall, $hospital, $school, $market_area, $rename_image_01, $rename_image_02, $rename_image_03, $rename_image_04, $rename_image_05, $description]);
...
<section class="property-form">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="box">
            <p>advance amount <span>*</span></p>
            <input type="number" name="advance" required min="0" max="9999999999" maxlength="10" placeholder="enter advance amount" class="input">
         </div>
         <div class="box">
